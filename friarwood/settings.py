...
DATABASES = {
        'default': {
            ...
            'NAME': 'friarwood',                      # Or path to database file if using sqlite3.
            # The following settings are not used with sqlite3:
            'USER': 'friarwood',
            'PASSWORD': 'friarwood',
            'HOST': '52.16.41.189',                      # Empty for localhost through domain sockets or           '127.0.0.1' for localhost through TCP.
